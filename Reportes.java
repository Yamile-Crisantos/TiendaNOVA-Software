...
public class Reportes {
    ...
    public void ReportesClientes() {
        ...
        try {
            ...
            PdfWriter.getInstance(documento, new FileOutputStream(ruta + "C:\\Users\\yamil\\OneDrive\\Desktop\\REPORTES_TiendaNOVA\\Clientes/Reporte_Clientes.pdf"));
    ...
    public void ReportesProductos() {
        ...
        try {
            String ruta = System.getProperty("user.home");
            PdfWriter.getInstance(documento, new FileOutputStream(ruta + "C:\\Users\\yamil\\OneDrive\\Desktop\\REPORTES_TiendaNOVA\\Productos/Reporte_Productos.pdf"));
            Image header = Image.getInstance("src/img/header1.jpg");
            header.scaleToFit(650, 1000);
            header.setAlignment(Chunk.ALIGN_CENTER);
            //formato al texto
    ...
    public void ReportesCategorias() {
        ...
        try {
            String ruta = System.getProperty("user.home");
            PdfWriter.getInstance(documento, new FileOutputStream(ruta + "C:\\Users\\yamil\\OneDrive\\Desktop\\REPORTES_TiendaNOVA\\Categoria/Reporte_Categorias.pdf"));
            Image header = Image.getInstance("src/img/header1.jpg");
            header.scaleToFit(650, 1000);
            header.setAlignment(Chunk.ALIGN_CENTER);
            //formato al texto
    ...
    public void ReportesVentas() {
        ...
        try {
            String ruta = System.getProperty("user.home");
            PdfWriter.getInstance(documento, new FileOutputStream(ruta + "C:\\Users\\yamil\\OneDrive\\Desktop\\REPORTES_TiendaNOVA\\Ventas/Reporte_Ventas.pdf"));
            Image header = Image.getInstance("src/img/header1.jpg");
            header.scaleToFit(650, 1000);
            header.setAlignment(Chunk.ALIGN_CENTER);
            //formato al texto
